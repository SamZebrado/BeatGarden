...
import { resetTutorialProgress } from '../game/tutorialProgress';
...
export class SettingsView {
  ...
  private render(): void {
    ...
    page.querySelector('[data-role="tutorial-reset"]')!.addEventListener('click', () => {
      resetTutorialProgress();
      page.querySelector<HTMLOutputElement>('[data-role="tutorial-status"]')!.textContent = t('settings.tutorialResetDone');
    });
